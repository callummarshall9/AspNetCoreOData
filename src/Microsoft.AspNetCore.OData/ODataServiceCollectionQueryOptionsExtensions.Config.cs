...
{
    /// <summary>
    /// This partial class defines the configuration on <see cref="ODataServiceCollectionQueryOptionsExtensions"/>.
    /// </summary>
    public partial class ODataServiceCollectionQueryOptionsExtensions
    {
        ...
        /// </summary>
        public ODataServiceCollectionQueryOptionsExtensions()
        {
